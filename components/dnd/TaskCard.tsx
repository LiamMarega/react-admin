...
import { DeleteButton } from '@/assets/icons';
    ...
    >
      ...
      {mouseIsOver && (
        <button
          ...
          className='stroke-white absolute right-4 top-1/2 -translate-y-1/2 bg-black p-2 rounded opacity-60 hover:opacity-200'
        >
          <DeleteButton />
        </button>
      )}
